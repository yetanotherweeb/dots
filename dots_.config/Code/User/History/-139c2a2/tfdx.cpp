                ...
                if (!all_episode_urls.empty()) 
                {
                    for (const auto& episode_data : all_episode_urls) {
                        ...
                        if (!watch_url.empty()) 
                        {
                            ...
                            // İzleme URL'si ve ilgili bilgiler ekrana yazdırılabilir
                            std::cout << "İzleniyor: " << selected_anime_name << " - Bölüm " 
                                      << episode_number << ", Sezon " 
                                      << season_number << "\n";
                            std::cout << "Watch URL: " << watch_url << "\n";
                        } 
                        else 
                        {
