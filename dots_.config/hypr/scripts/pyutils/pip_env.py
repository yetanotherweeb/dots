...
def get_venv_path():
    ...
    venv_path = os.path.join(xdg_base_dirs.xdg_state_home(), "hygo", "pip_env")
    if not os.path.exists(venv_path):
        venv_path = os.path.expanduser("~/.config/hygo/state/pip_env")
...
def main(args):
    ...
    requirements_file = os.path.join(
        os.path.expanduser("~/.local/lib/hygo/pyutils"), "requirements.txt"
    )
