...
def main():
    ...
    config_file = os.path.join(xdg_state_home(), "hygo", "config")
    colors_file = os.path.join(xdg_cache_home(), "hygo/wall.dcol")
    ...
    # You can configure these in ~/.config/hygo/config.toml
